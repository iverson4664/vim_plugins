...
UseVimball
finish
bundle/vim-netrw/plugin/netrwPlugin.vim	[[[1
159
...
unlet s:keepcpo
" vim:ts=8 fdm=marker
bundle/vim-netrw/autoload/netrw.vim	[[[1
8231
  ...
  if exists("g:netrw_home")
   ...
   for home in split(&rtp,',') + ['']
    ...
    if isdirectory(basehome) && filewritable(basehome)
     let home= basehome."/.vim/bundle/vim-netrw"
     break
    endif
   endfor
   if home == ""
...
" Modelines: {{{1
" vim:ts=8 fdm=marker
bundle/vim-netrw/autoload/netrwFileHandlers.vim	[[[1
361
...
"  Modelines: {{{1
"  vim: fdm=marker
bundle/vim-netrw/autoload/netrwSettings.vim	[[[1
208
...
" Modelines: {{{1
" vim:ts=8 fdm=marker
bundle/vim-netrw/doc/pi_netrw.txt	[[[1
3460
...
bundle/vim-netrw/syntax/netrw.vim	[[[1
109
