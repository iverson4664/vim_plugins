...
if !hasmapto('<Plug>MarkSet', 'n')
	"happy marked nmap <unique> <silent> <Leader>m <Plug>MarkSet
	nmap <unique> <silent> mm <Plug>MarkSet
endif
if !hasmapto('<Plug>MarkSet', 'v')
	"happy marked vmap <unique> <silent> <Leader>m <Plug>MarkSet
	vmap <unique> <silent> mm <Plug>MarkSet
endif
if !hasmapto('<Plug>MarkRegex', 'n')
	"happy marked nmap <unique> <silent> <Leader>r <Plug>MarkRegex
	nmap <unique> <silent> mr <Plug>MarkRegex
endif
if !hasmapto('<Plug>MarkRegex', 'v')
	"happy marked vmap <unique> <silent> <Leader>r <Plug>MarkRegex
	vmap <unique> <silent> mr <Plug>MarkRegex
endif
if !hasmapto('<Plug>MarkClear', 'n')
	"happy marked nmap <unique> <silent> <Leader>n <Plug>MarkClear
