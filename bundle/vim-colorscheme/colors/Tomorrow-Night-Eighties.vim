...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	" call <SID>X("Search", s:background, "f0a0c0", "underline")
	" call <SID>X("Search", s:background, s:yellow, "")
    call <SID>X("Search", "f0a0c0", s:line, "underline")
	" call <SID>X("TabLine", s:foreground, s:background, "reverse")
    call <SID>X("TabLine", "8a8a8a","000000","italic")
    call <SID>X("TabLineFill",s:background,"","")
    call <SID>X("TabLineSel","e4e4e4","000000","italic,bold")
	call <SID>X("StatusLine", s:line, s:yellow, "reverse")
	call <SID>X("StatusLineNC", s:line, s:foreground, "reverse")
	" call <SID>X("StatusLine", s:window, s:yellow, "reverse")
	" call <SID>X("StatusLineNC", s:window, s:foreground, "reverse")
	call <SID>X("VertSplit", s:background,"","")
